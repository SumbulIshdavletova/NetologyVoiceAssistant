package com.example.netologyvoiceassistant.activity
...
class MainActivity : AppCompatActivity() {
    ...
    val VOICE_RECOGNITION_REQUEST_CODE: Int = 234
    ...
    private fun initViews() {
        ...
        val voiceInputButton: FloatingActionButton = findViewById(R.id.fab)
